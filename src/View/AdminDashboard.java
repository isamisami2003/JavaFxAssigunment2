...
public class AdminDashboard extends Stage{
    ...
    public AdminDashboard() throws IOException {
        ...
        FXMLLoader CreateAccountsLoader = new FXMLLoader(getClass().getResource("AdminFXML/CreateAccounts.fxml"));
        Parent CreateAccountsRoot = CreateAccountsLoader.load();     
        CreateAccounts = new Scene(CreateAccountsRoot);        
    ...
    public void changeSceneToCreatAccount(){
        this.setScene(CreateAccounts);
    }    
